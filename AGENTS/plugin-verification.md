...
├── .agents/plugins/marketplace.json  # Codex marketplace (git-subdir sources, auto-generated)
...
- [ ] `.agents/plugins/marketplace.json` valid JSON (auto-generated by pre-commit from `.claude-plugin/`)
